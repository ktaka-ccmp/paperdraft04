...
We evaluated the behavior of the ECMP routing table updates, by changing the number of the load balancers.
...
We also carried out throughput measurement to show our proposed architecture increases as we increase the number of the load balancers.
\begin{figure}[tb]
