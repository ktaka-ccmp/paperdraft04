...
In this paper, we propose a software load balancer with Equal Cost Multi-Path(ECMP)\cite{} redundancy for container cluster environment without a cloud load balancer.
