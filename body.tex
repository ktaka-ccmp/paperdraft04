...
The agent behaved as though different BGP connections belonged to a single BGP session because the source IP addresses were the same.
...
We examined the basic performance of the our proposed load balancer container and the basic function of the ECMP redundancy cluster of physical servers in on-premise data center.
...
\begin{figure}[tb]
\includegraphics[width=\columnwidth]{Figs/gcp_all_ieice}
\caption{Performance of the proposed load balancer in GCP.}
\label{fig:gcp_all_ieice}
\end{figure}

\begin{figure}[tb]
\includegraphics[width=\columnwidth]{Figs/aws_c4_ieice}
\caption{Performance of the proposed load balancer in AWS.}
...
\begin{figure}[tb]
\includegraphics[width=\columnwidth]{Figs/ecmp_lb_cubic}
