...
It is also capable of health-checking the liveness of {\em real server}, 
...
\end{Verbatim}
  ...
  \caption{
    (a) Benchmark setup. (b) Benchmark command line and output example. (c) Hardware and software specifications.
  }
